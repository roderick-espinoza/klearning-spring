...
public interface ProduccionRepository extends JpaRepository<Produccion, String> {
    ...
    List<Produccion> findByPersona_IdPersonaAndEstado(String idPersona, String estado);

    //Sirve para: Buscar las tareas que hizo una persona en un proyecto específico.

    List<Produccion> findByPersona_DniCeAndProyecto_IdProyectoAndEstado(String dniCe, String idProyecto, String estado);

    //Sirve para: Obtener el historial de tareas de un trabajador buscándolo por su DNI.

    Page<Produccion> findByPersona_DniCeAndEstado(String dniCe, String estado, Pageable pageable);
    ...
    Page<Produccion> findByFechaHoraInicioBetweenAndEstado(LocalDateTime inicio, LocalDateTime fin, String estado, Pageable pageable);
